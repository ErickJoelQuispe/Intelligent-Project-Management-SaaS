 ...
 *
 * <p>Tests authentication and endpoint behavior with mocked use cases.
 */
...
class NotificationControllerTest {
    ...
    void listNotifications_withValidJwt_returnsNotifications() throws Exception {
        ...
        when(notificationService.listForUser(tenantId, userId)).thenReturn(List.of(notification));
