package com.epm.user.infrastructure.config;
...
/**
 * Spring MVC (NOT WebFlux) Security configuration for user-service.
 *
 * <p>All endpoints require JWT authentication (no public endpoints in user-service).
 * Custom {@link JwtAuthenticationConverter} navigates the nested
