...
/**
 * Spring MVC (NOT WebFlux) Security configuration for project-service.
 *
 * <p>All endpoints require JWT authentication. Custom {@link JwtAuthenticationConverter}
 * navigates the nested {@code realm_access.roles} claim structure that Keycloak produces.
 */
@Configuration
@EnableWebSecurity
