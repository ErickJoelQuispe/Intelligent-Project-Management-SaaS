...
class OutboxRelayIT extends AbstractPostgresIT {
    ...
    void alreadyPublishedRow_isIgnored() {
        OutboxEventJpaEntity published = persist(newRow(), Instant.now(), Instant.now(), null);
    ...
    private OutboxEventJpaEntity persist(OutboxEventJpaEntity e, Instant createdAt, Instant publishedAt, Instant failedAt) {
