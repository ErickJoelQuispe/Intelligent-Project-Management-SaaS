      ...
      @if (icon()) {
        ...
        <div class="relative flex items-center justify-center mb-5">
          ...
          <div class="absolute rounded-full"
               [class]="auraClasses()"
               style="background: var(--color-accent-subtle); filter: blur(16px);">
          </div>
          ...
          <div class="relative flex items-center justify-center rounded-2xl"
               ...
               style="background: color-mix(in oklch, var(--color-bg-surface) 80%, transparent);
                      ...
                      box-shadow: 0 0 20px color-mix(in oklch, var(--color-accent) 10%, transparent), inset 0 1px 0 oklch(1 0 0 / 0.04);">
